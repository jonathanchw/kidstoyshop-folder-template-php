<style>
    ...
    @if(empty($content->primary_color)):root {
        --primary-color: #daff5c;
    }
    ...
    @endif @if(empty($content->secondary_color)):root {
        --secondary-color: #0f3d2d;
    }
    ...
    @endif @if(empty($content->background_color)):root {
        --background-color: #904b6f;
    }
    ...
    @endif @if(empty($content->text_color)):root {
        --text-color: #3a1700;
    }
    ...
    @endif @if(empty($content->header_color)):root {
        --header-color: #aa4a6f;
    }
